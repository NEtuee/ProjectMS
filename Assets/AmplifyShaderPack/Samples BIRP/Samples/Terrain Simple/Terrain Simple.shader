...
Shader "AmplifyShaderPack/Terrain/Simple"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_707_0_g19 = ( localCalculateTangentsStandard706_g19 + ase_normalOS );
			v.normal = temp_output_707_0_g19;
			float4 appendResult704_g19 = (float4(cross( ase_normalOS , float3( 0, 0, 1 ) ) , -1.0));
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 appendResult514_g19 = (float3(break513_g19.x , break513_g19.y , ( break513_g19.z + 0.001 )));
				...
				float3 staticSwitch503_g19 = appendResult514_g19;
			#endif
			float3 NormalOut80 = staticSwitch503_g19;
			...
			float3 weightedBlend9_g19 = ( weightedBlendVar9_g19.x*Splat0342_g19 + weightedBlendVar9_g19.y*Splat1379_g19 + weightedBlendVar9_g19.z*Splat2357_g19 + weightedBlendVar9_g19.w*Splat3390_g19 );
			...
			float3 BaseColorOut79 = localClipHoles453_g19;
			float3 ase_positionWS = i.worldPos;
			float3 normalizeResult66 = normalize( ase_positionWS );
			...
			float weightedBlend536_g19 = ( weightedBlendVar536_g19.x*max( _Metallic0 , Mask0R334_g19 ) + weightedBlendVar536_g19.y*max( _Metallic1 , Mask1R370_g19 ) + weightedBlendVar536_g19.z*max( _Metallic2 , Mask2R359_g19 ) + weightedBlendVar536_g19.w*max( _Metallic3 , Mask3R388_g19 ) );
			o.Metallic = weightedBlend536_g19;
			float4 appendResult1168_g19 = (float4(_Smoothness0 , _Smoothness1 , _Smoothness2 , _Smoothness3));
			float Splat0A435_g19 = tex2DNode414_g19.a;
			float Mask1A369_g19 = tex2DNode422_g19.a;
			float Mask2A360_g19 = tex2DNode419_g19.a;
			float Mask3A391_g19 = tex2DNode425_g19.a;
			float4 appendResult1169_g19 = (float4(Splat0A435_g19 , Mask1A369_g19 , Mask2A360_g19 , Mask3A391_g19));
			float dotResult1166_g19 = dot( ( appendResult1168_g19 * appendResult1169_g19 ) , Control26_g19 );
			o.Smoothness = dotResult1166_g19;
...
/*ASEBEGIN
Version=19902
Node;AmplifyShaderEditor.WorldPosInputsNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;74;-1376,832;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalizeNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;66;-1184,832;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BreakToComponentsNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;65;-1024,832;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;64;-896,944;Half;False;Constant;_Float41;Float 39;55;0;Create;True;1;;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;60;-864,864;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;57;-1024,1024;Half;False;Property;_FogHeight;Fog Height;2;0;Create;True;1;;0;0;False;0;False;0.1;0.41;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;62;-896,1104;Half;False;Constant;_Float42;Float 40;55;0;Create;True;1;;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;56;-1024,1200;Half;False;Property;_FogSmoothness;Fog Smoothness;3;0;Create;True;1;;0;0;False;0;False;0.75;0.01;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;72;-720,864;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;61;-704,1200;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;59;-528,864;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;91;64,64;Inherit;False;Terrain 4 Layer;5;;19;a8a57459582f78d4ca5db58f601fb616;4,504,1,102,1,669,0,668,0;0;8;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;709;FLOAT4;701
Node;AmplifyShaderEditor.FogAndAmbientColorsNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;71;-464,672;Inherit;False;unity_FogColor;0;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;82;-208,592;Inherit;False;80;NormalOut;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;69;-368,864;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;67;-384,960;Half;False;Constant;_Float43;Float 41;55;0;Create;True;1;;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;55;-512,1040;Half;False;Property;_FogFill;Fog Fill;1;0;Create;True;1;;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;80;320,64;Inherit;False;NormalOut;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SwizzleNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;76;-192,672;Inherit;False;FLOAT3;0;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;79;320,-32;Inherit;False;BaseColorOut;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;77;-16,592;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;68;-208,864;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;83;-272,768;Inherit;False;79;BaseColorOut;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;81;-48,512;Inherit;False;80;NormalOut;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;78;160,576;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;70;-32,704;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;63;224,880;Half;False;Property;_EnableFog;Enable Fog;0;2;[Header];[ToggleUI];Create;True;1;FOG;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;84;144,784;Inherit;False;79;BaseColorOut;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;75;368,512;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;58;384,688;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;87;544,512;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;88;560,672;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;50;656,528;Inherit;False;757.9001;428.2;BIRP First Pass;;0,0,0,1;Additional Directives:$$#pragma instancing_options assumeuniformscaling nomatrices nolightprobe nolightmap forwardadd$#pragma multi_compile_local __ _NORMALMAP$#pragma shader_feature_local _MASKMAP$#pragma multi_compile_local_fragment __ _ALPHATEST_ON$#pragma multi_compile_fog$#pragma editor_sync_compilation$#pragma target 3.0$#pragma exclude_renderers gles$#define TERRAIN_SPLATMAP_COMMON_CGINC_INCLUDED$#include UnityPBSLighting.cginc$#include TerrainSplatmapCommon.cginc$#define TERRAIN_STANDARD_SHADER$#define TERRAIN_SURFACE_OUTPUT SurfaceOutputStandard$$$Custom SubShader Tags:$$TerrainCompatible = True$;0;0
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;642.0813,-247.3737;Inherit;False;262;102;SplatmapFinalColor;;0,0,0,1;Additional Surface Options:$finalcolor:SplatmapFinalColor;0;0
Node;AmplifyShaderEditor.CustomExpressionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;45;643.3015,-133.2568;Float;False;FinalColor *= SurfaceOut.Alpha@;8;Create;3;True;SurfaceIn;OBJECT;0;In;Input;Float;False;True;SurfaceOut;OBJECT;0;In;SurfaceOutputStandard;Float;False;True;FinalColor;OBJECT;0;InOut;fixed4;Float;False;SplatmapFinalColor;False;True;0;;False;4;0;FLOAT;0;False;1;OBJECT;0;False;2;OBJECT;0;False;3;OBJECT;0;False;2;FLOAT;0;OBJECT;4
Node;AmplifyShaderEditor.WireNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;85;544,128;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;0;3;91;56
WireConnection;0;4;91;45
WireConnection;0;5;91;200
WireConnection;0;9;91;282
WireConnection;0;12;91;709
WireConnection;0;16;91;701
ASEEND*/
//CHKSM=DADEB585069F3BFBB1D2F05D950FDF3559C19293