		...
		Pass
		{
			...
			CGPROGRAM
							...
							) : SV_Target
				{
					...
					float2 temp_output_133_0_g14 = ( ( IN.ase_texcoord6.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					...
					float2 temp_output_1219_0_g48 = (IN.ase_texcoord6.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
					...
					float2 temp_output_1255_0_g48 = (IN.ase_texcoord7.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
					...
					float3 tanNormal1070_g48 = temp_output_33_6;
					float3 worldNormal1070_g48 = float3( dot( tanToWorld0, tanNormal1070_g48 ), dot( tanToWorld1, tanNormal1070_g48 ), dot( tanToWorld2, tanNormal1070_g48 ) );
					float3 NormalWS1073_g48 = worldNormal1070_g48;
					float3 NormalWorld963_g48 = NormalWS1073_g48;
					{
					...
					o.Albedo = temp_output_89_0_g14;
					o.Normal = temp_output_33_6;

					half3 Specular = ( temp_output_202_0_g14 * (SAMPLE_TEXTURE2D( _SpecularMap, sampler_MainTex, temp_output_133_0_g14 )).rgb * _SpecularStrength );
					half Metallic = 0;
					half Smoothness = ( _SmoothnessStrength * (SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_MainTex, temp_output_133_0_g14 )).rgb ).x;
					half Occlusion = saturate( ( ( 1.0 - _OcclusionStrengthAO ) * (SAMPLE_TEXTURE2D( _OcclusionMap, sampler_MainTex, temp_output_133_0_g14 )).rgb ) ).x;
					...
					half3 BakedGI = lerpResult941_g48;
		...
		Pass
		{
			...
			CGPROGRAM
					...
					) : SV_Target
				{
					...
					float2 temp_output_133_0_g14 = ( ( IN.ase_texcoord5.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
					float3 temp_output_89_0_g14 = ( (_BaseColor).rgb * (tex2DNode21_g14).rgb * _Brightness );
		...
		Pass
		{
			...
			CGPROGRAM
				...
				)
				{
					...
					float2 temp_output_1219_0_g48 = (IN.ase_texcoord4.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
					float2 UV1Static1247_g48 = temp_output_1219_0_g48;
					float4 tex2DNode810_g48 = SAMPLE_TEXTURE2D( unity_Lightmap, samplerunity_Lightmap, UV1Static1247_g48 );
					float3 temp_output_840_0_g48 = (tex2DNode810_g48).rgb;
					float localASEDecodeDirectionalLightmap963_g48 = ( 0.0 );
					float3 Color963_g48 = temp_output_840_0_g48;
					float2 temp_output_1255_0_g48 = (IN.ase_texcoord5.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
					float2 UV2Dynamic1251_g48 = temp_output_1255_0_g48;
					float4 tex2DNode911_g48 = SAMPLE_TEXTURE2D( unity_LightmapInd, samplerunity_Lightmap, UV2Dynamic1251_g48 );
					float4 DirTex963_g48 = tex2DNode911_g48;
					float3 tanToWorld0 = float3( TangentWS.x, BitangentWS.x, NormalWS.x );
		...
		Pass
		{
			...
			Pass
			{
							...
							) : SV_Target
				{
					...
					float2 temp_output_133_0_g14 = ( ( IN.ase_texcoord1.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
					float MapBaseColorAlpha107_g14 = tex2DNode21_g14.a;
					clip( MapBaseColorAlpha107_g14 - ( 1.0 - _AlphaCutoffBias ));
					float temp_output_115_0_g14 = saturate( MapBaseColorAlpha107_g14 );
...
/*ASEBEGIN
Version=19902
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;41;512,-80;Inherit;False;Property;_Cull;Render Face;0;1;[Enum];Create;False;1;;0;1;Front,2,Back,1,Both,0;True;0;False;2;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;33;-144,0;Inherit;False;Material Sample;1;;14;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;11;FLOAT3;1;FLOAT3;6;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;42;176,272;Inherit;False;Material Baked GI;35;;48;4963945102cd7c746bbe83f48754e7cb;8,910,0,827,0,826,0,838,0,831,0,839,0,1322,0,1323,0;3;975;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;36;512,0;Float;False;True;-1;2;AmplifyShaderEditor.MaterialInspector;0;4;AmplifyShaderPack/Baked GI Specular Cutout;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;17;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=False=DisableBatching;True;3;False;0;False;True;1;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;0;;0;0;Standard;44;Category;0;0;  Instanced Terrain Normals;1;0;Workflow;1;0;Surface;1;638163517288016837;  Blend;0;0;  Dither Shadows;1;0;Two Sided;1;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Deferred Pass;1;0;Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;Receive Shadows;1;0;Receive Specular;1;0;Receive Reflections;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Ambient Light;1;0;Meta Pass;1;0;Add Pass;1;0;Override Baked GI;1;638163119442270393;Write Depth;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;6;False;True;True;True;True;True;False;;True;0
...
ASEEND*/
//CHKSM=E15678B59BCE5B44AFDEE40D30BF5D03133B7431