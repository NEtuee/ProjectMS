		...
		Pass
		{
			...
			CGPROGRAM
							...
							) : SV_Target
				{
					...
					float2 temp_output_133_0_g18 = ( ( IN.ase_texcoord6.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					...
					float3 tanNormal1070_g48 = temp_output_45_6;
					...
					o.Albedo = temp_output_89_0_g18;
					o.Normal = temp_output_45_6;

					half3 Specular = ( temp_output_202_0_g18 * (SAMPLE_TEXTURE2D( _SpecularMap, sampler_MainTex, temp_output_133_0_g18 )).rgb * _SpecularStrength );
					half Metallic = 0;
					half Smoothness = ( _SmoothnessStrength * (SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_MainTex, temp_output_133_0_g18 )).rgb ).x;
					half Occlusion = saturate( ( ( 1.0 - _OcclusionStrengthAO ) * (SAMPLE_TEXTURE2D( _OcclusionMap, sampler_MainTex, temp_output_133_0_g18 )).rgb ) ).x;
		...
		Pass
		{
			...
			CGPROGRAM
					...
					) : SV_Target
				{
					...
					float2 temp_output_133_0_g18 = ( ( IN.ase_texcoord5.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					float4 tex2DNode21_g18 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g18 );
					float3 temp_output_89_0_g18 = ( (_BaseColor).rgb * (tex2DNode21_g18).rgb * _Brightness );
		...
		Pass
		{
			...
			CGPROGRAM
				...
				)
				{
					...
					float2 temp_output_133_0_g18 = ( ( IN.ase_texcoord4.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					float4 tex2DNode21_g18 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g18 );
					float3 temp_output_89_0_g18 = ( (_BaseColor).rgb * (tex2DNode21_g18).rgb * _Brightness );
		...
		Pass
		{
			...
			CGPROGRAM
				...
				half4 frag( v2f IN  ) : SV_Target
				{
					...
					float2 temp_output_133_0_g18 = ( ( IN.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					float4 tex2DNode21_g18 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g18 );
					float3 temp_output_89_0_g18 = ( (_BaseColor).rgb * (tex2DNode21_g18).rgb * _Brightness );
...
/*ASEBEGIN
Version=19902
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;45;-160,0;Inherit;False;Material Sample;1;;18;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;11;FLOAT3;1;FLOAT3;6;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;41;512,-80;Inherit;False;Property;_Cull;Render Face;0;1;[Enum];Create;False;1;;0;1;Front,2,Back,1,Both,0;True;0;False;2;2;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;49;160,240;Inherit;False;Material Baked GI;35;;48;4963945102cd7c746bbe83f48754e7cb;8,910,0,827,0,826,0,838,0,831,0,839,0,1322,0,1323,0;3;975;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;36;512,0;Float;False;True;-1;2;AmplifyShaderEditor.MaterialInspector;0;4;AmplifyShaderPack/Baked GI Specular;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;17;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;3;False;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;0;;0;0;Standard;44;Category;0;0;  Instanced Terrain Normals;1;0;Workflow;1;0;Surface;0;0;  Blend;0;0;  Dither Shadows;1;0;Two Sided;1;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Deferred Pass;1;0;Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;Receive Shadows;1;0;Receive Specular;1;0;Receive Reflections;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Ambient Light;1;0;Meta Pass;1;0;Add Pass;1;0;Override Baked GI;1;638163119442270393;Write Depth;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;6;False;True;True;True;True;True;False;;True;0
WireConnection;49;975;45;6
WireConnection;36;0;45;1
...
ASEEND*/
//CHKSM=0901B092C35831923DB1F239CC5CF66B89873811