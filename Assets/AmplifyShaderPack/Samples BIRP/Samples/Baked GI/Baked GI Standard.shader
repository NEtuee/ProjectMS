		...
		Pass
		{
			...
			CGPROGRAM
							...
							) : SV_Target
				{
					...
					float2 temp_output_133_0_g48 = ( ( IN.ase_texcoord6.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					float4 tex2DNode21_g48 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g48 );
					float3 temp_output_89_0_g48 = ( (_BaseColor).rgb * (tex2DNode21_g48).rgb * _Brightness );
					
					float3 temp_output_33_6 = UnpackScaleNormal( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, temp_output_133_0_g48 ), _NormalStrength );
					
					float2 temp_output_1219_0_g43 = (IN.ase_texcoord6.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
					...
					float2 temp_output_1255_0_g43 = (IN.ase_texcoord7.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
					...
					float3 tanNormal1070_g43 = temp_output_33_6;
					float3 worldNormal1070_g43 = float3( dot( tanToWorld0, tanNormal1070_g43 ), dot( tanToWorld1, tanNormal1070_g43 ), dot( tanToWorld2, tanNormal1070_g43 ) );
					float3 NormalWS1073_g43 = worldNormal1070_g43;
					float3 NormalWorld963_g43 = NormalWS1073_g43;
					{
					...
					o.Albedo = temp_output_89_0_g48;
					o.Normal = temp_output_33_6;

					half3 Specular = half3( 0, 0, 0 );
					half Metallic = ( _MetallicStrength * (SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MainTex, temp_output_133_0_g48 )).rgb ).x;
					half Smoothness = ( _SmoothnessStrength * (SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_MainTex, temp_output_133_0_g48 )).rgb ).x;
					half Occlusion = saturate( ( ( 1.0 - _OcclusionStrengthAO ) * (SAMPLE_TEXTURE2D( _OcclusionMap, sampler_MainTex, temp_output_133_0_g48 )).rgb ) ).x;
					...
					half3 BakedGI = lerpResult941_g43;
		...
		Pass
		{
			...
			CGPROGRAM
					...
					) : SV_Target
				{
					...
					float2 temp_output_133_0_g48 = ( ( IN.ase_texcoord5.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					float4 tex2DNode21_g48 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g48 );
					float3 temp_output_89_0_g48 = ( (_BaseColor).rgb * (tex2DNode21_g48).rgb * _Brightness );
		...
		Pass
		{
			...
			CGPROGRAM
				...
				)
				{
					...
					float2 temp_output_133_0_g48 = ( ( IN.ase_texcoord4.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					float4 tex2DNode21_g48 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g48 );
					float3 temp_output_89_0_g48 = ( (_BaseColor).rgb * (tex2DNode21_g48).rgb * _Brightness );
					
					float3 temp_output_33_6 = UnpackScaleNormal( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, temp_output_133_0_g48 ), _NormalStrength );
					
					float2 temp_output_1219_0_g43 = (IN.ase_texcoord4.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
					float2 UV1Static1247_g43 = temp_output_1219_0_g43;
					float4 tex2DNode810_g43 = SAMPLE_TEXTURE2D( unity_Lightmap, samplerunity_Lightmap, UV1Static1247_g43 );
					float3 temp_output_840_0_g43 = (tex2DNode810_g43).rgb;
					float localASEDecodeDirectionalLightmap963_g43 = ( 0.0 );
					float3 Color963_g43 = temp_output_840_0_g43;
					float2 temp_output_1255_0_g43 = (IN.ase_texcoord5.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
					float2 UV2Dynamic1251_g43 = temp_output_1255_0_g43;
					float4 tex2DNode911_g43 = SAMPLE_TEXTURE2D( unity_LightmapInd, samplerunity_Lightmap, UV2Dynamic1251_g43 );
					float4 DirTex963_g43 = tex2DNode911_g43;
					float3 tanToWorld0 = float3( TangentWS.x, BitangentWS.x, NormalWS.x );
		...
		Pass
		{
			...
			CGPROGRAM
				...
				half4 frag( v2f IN  ) : SV_Target
				{
					...
					float2 temp_output_133_0_g48 = ( ( IN.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					float4 tex2DNode21_g48 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g48 );
					float3 temp_output_89_0_g48 = ( (_BaseColor).rgb * (tex2DNode21_g48).rgb * _Brightness );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;36;506.9998,-25;Float;False;True;-1;2;AmplifyShaderEditor.MaterialInspector;0;4;AmplifyShaderPack/Baked GI Standard;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;17;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;3;False;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;0;;0;0;Standard;44;Category;0;0;  Instanced Terrain Normals;1;0;Workflow;1;0;Surface;0;0;  Blend;0;0;  Dither Shadows;1;0;Two Sided;1;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Deferred Pass;1;0;Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;Receive Shadows;1;638163547443847516;Receive Specular;1;0;Receive Reflections;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Ambient Light;1;0;Meta Pass;1;0;Add Pass;1;638163547550790845;Override Baked GI;1;638163119442270393;Write Depth;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;6;False;True;True;True;True;True;False;;True;0
...
ASEEND*/
//CHKSM=F1DB213607F41BA854B28F1B978040A7D5917C62