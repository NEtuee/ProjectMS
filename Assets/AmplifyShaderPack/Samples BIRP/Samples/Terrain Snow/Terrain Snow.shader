...
Shader "AmplifyShaderPack/Terrain/Snow"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_707_0_g5 = ( localCalculateTangentsStandard706_g5 + ase_normalOS );
			v.normal = temp_output_707_0_g5;
			float4 appendResult704_g5 = (float4(cross( ase_normalOS , float3( 0, 0, 1 ) ) , -1.0));
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_21_0_g6 = ( 1.0 - _SnowSaturation );
			float3 lerpResult31_g6 = lerp( temp_cast_6 , temp_output_12_0_g6 , temp_output_21_0_g6);
			...
			float3 WorldPosition812_g5 = ase_positionWS;
