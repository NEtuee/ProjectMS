...
Shader "AmplifyShaderPack/Community/Physical Based Rendering Eye"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 temp_output_230_0_g73805 = Normal_WS1160_g73678;
			float dotResult151_g73805 = dot( temp_output_230_0_g73805 , ase_viewDirSafeWS );
			float Dot_NdotV210_g73678 = max( dotResult151_g73805 , 0.0 );
			float3 temp_output_230_0_g73794 = Normal_WS1160_g73678;
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aseld
			float3 ase_lightDirWS = 0;
			#else //aseld
			float3 ase_lightDirWS = Unity_SafeNormalize( UnityWorldSpaceLightDir( ase_positionWS ) );
			#endif //aseld
			float dotResult152_g73794 = dot( temp_output_230_0_g73794 , ase_lightDirWS );
			float temp_output_2182_111_g73678 = dotResult152_g73794;
			float temp_output_2154_0_g73678 = max( temp_output_2182_111_g73678 , 0.0 );
			...
			float2 appendResult44_g73773 = (float2(NdotL373_g73769 , NdotV372_g73769));
			float2 temp_output_330_0_g73773 = saturate( ( 1.0 - appendResult44_g73773 ) );
			float2 temp_output_331_0_g73773 = ( temp_output_330_0_g73773 * temp_output_330_0_g73773 * temp_output_330_0_g73773 * temp_output_330_0_g73773 * temp_output_330_0_g73773 );
			float3 normalizeResult176_g73799 = normalize( ( ase_lightDirWS + ase_viewDirSafeWS ) );
			float dotResult159_g73799 = dot( ase_lightDirWS , normalizeResult176_g73799 );
			float temp_output_965_112_g73678 = max( dotResult159_g73799 , 0.0 );
			float Dot_LdotH972_g73678 = temp_output_965_112_g73678;
			float Dot_LdotH_Total2265_g73678 = Dot_LdotH972_g73678;
			float LdotH643_g73769 = Dot_LdotH_Total2265_g73678;
			float2 break335_g73773 = ( ( 1.0 - temp_output_331_0_g73773 ) + ( temp_output_331_0_g73773 * ( ( LdotH643_g73769 * LdotH643_g73769 * _Roughness707_g73769 * 2.0 ) + 0.5 ) ) );
			float temp_output_336_0_g73773 = ( break335_g73773.x * break335_g73773.y );
			...
			float3 diffuseColor77_g73769 = ( ( _Color98_g73769 * ( 1.0 - _Metallic711_g73769 ) * temp_output_336_0_g73773 ) + Indirect_Diffuse644_g73678 );
			...
			float3 temp_output_230_0_g73795 = Normal_WS1160_g73678;
			float3 normalizeResult447_g73795 = ASESafeNormalize( ( ase_viewDirSafeWS + ase_lightDirWS ) );
			float dotResult178_g73795 = dot( temp_output_230_0_g73795 , normalizeResult447_g73795 );
			float temp_output_882_109_g73678 = max( dotResult178_g73795 , 0.0 );
			float Dot_NdotH655_g73678 = temp_output_882_109_g73678;
			...
			float Dot_NdotL_Inv1390_g73678 = max( -temp_output_2182_111_g73678 , 0.0 );
...
ASEEND*/
//CHKSM=6E0E883D18620344EBF192C5163578C8AE16879D