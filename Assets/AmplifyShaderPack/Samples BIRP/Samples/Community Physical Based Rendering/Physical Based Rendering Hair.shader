...
Shader "AmplifyShaderPack/Community/Physical Based Rendering Hair"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 temp_output_230_0_g68751 = Normal_WS1160_g62248;
			float dotResult151_g68751 = dot( temp_output_230_0_g68751 , ase_viewDirSafeWS );
			float Dot_NdotV210_g62248 = max( dotResult151_g68751 , 0.0 );
			float3 temp_output_230_0_g68740 = Normal_WS1160_g62248;
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aseld
			float3 ase_lightDirWS = 0;
			#else //aseld
			float3 ase_lightDirWS = Unity_SafeNormalize( UnityWorldSpaceLightDir( ase_positionWS ) );
			#endif //aseld
			float dotResult152_g68740 = dot( temp_output_230_0_g68740 , ase_lightDirWS );
			float temp_output_2182_111_g62248 = dotResult152_g68740;
			float temp_output_2154_0_g62248 = max( temp_output_2182_111_g62248 , 0.0 );
			float Dot_NdotL208_g62248 = temp_output_2154_0_g62248;
			float Dot_NdotL_total2267_g62248 = Dot_NdotL208_g62248;
			float3 normalizeResult176_g68745 = normalize( ( ase_lightDirWS + ase_viewDirSafeWS ) );
			float dotResult159_g68745 = dot( ase_lightDirWS , normalizeResult176_g68745 );
			float temp_output_965_112_g62248 = max( dotResult159_g68745 , 0.0 );
			float Dot_LdotH972_g62248 = temp_output_965_112_g62248;
			float Dot_LdotH_Total2265_g62248 = Dot_LdotH972_g62248;
			float Shadow_65_g62248 = pow( saturate( ( ( ( ( Dot_NdotV210_g62248 * Dot_NdotL_total2267_g62248 ) / ( Dot_LdotH_Total2265_g62248 * max( Dot_NdotL_total2267_g62248 , Dot_NdotV210_g62248 ) ) ) * ( 1.0 - _ShadowStrength ) ) - _ShadowOffset ) ) , _ShadowFalloff );
			...
			float2 appendResult44_g68693 = (float2(NdotL373_g68689 , NdotV372_g68689));
			float2 temp_output_330_0_g68693 = saturate( ( 1.0 - appendResult44_g68693 ) );
			float2 temp_output_331_0_g68693 = ( temp_output_330_0_g68693 * temp_output_330_0_g68693 * temp_output_330_0_g68693 * temp_output_330_0_g68693 * temp_output_330_0_g68693 );
			float LdotH643_g68689 = Dot_LdotH_Total2265_g62248;
			float2 break335_g68693 = ( ( 1.0 - temp_output_331_0_g68693 ) + ( temp_output_331_0_g68693 * ( ( LdotH643_g68689 * LdotH643_g68689 * _Roughness707_g68689 * 2.0 ) + 0.5 ) ) );
			float temp_output_336_0_g68693 = ( break335_g68693.x * break335_g68693.y );
			...
			float3 diffuseColor77_g68689 = ( ( _Color98_g68689 * ( 1.0 - _Metallic711_g68689 ) * temp_output_336_0_g68693 ) + Indirect_Diffuse644_g62248 );
			float geoShadow142_g68689 = Shadow_65_g62248;
			float clampResult7_g68721 = clamp( _fresnelIOR , 1.0 , 4.0 );
			float temp_output_1_0_g68721 = ( pow( ( clampResult7_g68721 - 1.0 ) , 2.0 ) / pow( ( clampResult7_g68721 + 1.0 ) , 2.0 ) );
			float temp_output_169_0_g68721 = saturate( ( 1.0 - Dot_LdotH972_g62248 ) );
			float Fresnel_Term201_g62248 = ( temp_output_1_0_g68721 + ( ( 1.0 - temp_output_1_0_g68721 ) * ( temp_output_169_0_g68721 * temp_output_169_0_g68721 * temp_output_169_0_g68721 * temp_output_169_0_g68721 * temp_output_169_0_g68721 ) ) );
			...
			float3 normalizeResult2731_g62248 = normalize( ase_tangentWS );
			float3 Tangent_WS2280_g62248 = normalizeResult2731_g62248;
			float3 normalizeResult155_g68744 = ASESafeNormalize( ( ase_viewDirSafeWS + ase_lightDirWS ) );
			float dotResult238_g68744 = dot( Tangent_WS2280_g62248 , normalizeResult155_g68744 );
			float Dot_HdotX970_g62248 = dotResult238_g68744;
			float3 ase_bitangentWS = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3 normalizeResult2732_g62248 = normalize( ase_bitangentWS );
			float3 Bitangent_WS2279_g62248 = normalizeResult2732_g62248;
			float3 normalizeResult449_g68743 = ASESafeNormalize( ( ase_viewDirSafeWS + ase_lightDirWS ) );
			float dotResult242_g68743 = dot( Bitangent_WS2279_g62248 , normalizeResult449_g68743 );
			float Dot_HdotY971_g62248 = dotResult242_g68743;
			float2 appendResult485_g68725 = (float2(Dot_HdotX970_g62248 , Dot_HdotY971_g62248));
			float temp_output_2486_0_g62248 = ( 1.0 - Smoothness_417_g62248 );
			float temp_output_2485_0_g62248 = ( temp_output_2486_0_g62248 * temp_output_2486_0_g62248 );
			float temp_output_2482_0_g62248 = sqrt( ( 1.0 - ( _NDFAnistropic * 0.9 ) ) );
			float2 appendResult2487_g62248 = (float2(( temp_output_2485_0_g62248 / temp_output_2482_0_g62248 ) , ( temp_output_2482_0_g62248 * temp_output_2485_0_g62248 )));
			float2 temp_cast_4 = (0.001).xx;
			float3 normalizeResult155_g68750 = ASESafeNormalize( ( ase_viewDirSafeWS + ase_lightDirWS ) );
			float dotResult194_g68750 = dot( normalizeResult155_g68750 , normalizeResult155_g68750 );
			float Dot_HdotH969_g62248 = dotResult194_g68750;
			float3 appendResult487_g68725 = (float3(( appendResult485_g68725 / ( max( appendResult2487_g62248 , temp_cast_4 ) * 5 ) ) , Dot_HdotH969_g62248));
			float dotResult490_g68725 = dot( appendResult487_g68725 , appendResult487_g68725 );
			float2 break491_g68725 = ( max( appendResult2487_g62248 , temp_cast_4 ) * 5 );
			#if ( SHADER_TARGET >= 50 )
			float recip56_g68725 = rcp( ( ( dotResult490_g68725 * dotResult490_g68725 ) * break491_g68725.x * break491_g68725.y * UNITY_PI ) );
			#else
			float recip56_g68725 = 1.0 / ( ( dotResult490_g68725 * dotResult490_g68725 ) * break491_g68725.x * break491_g68725.y * UNITY_PI );
			#endif
			float Specular200_g62248 = recip56_g68725;
			...
			float Dot_NdotL_Inv1390_g62248 = max( -temp_output_2182_111_g62248 , 0.0 );
...
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;451;1664,-864;Inherit;False;291.9852;124.964;Physical Based Rendering Hair;;0,0,0,1;Physical Based Rendering Hair$-- GSF Ashikhmin Shirley$-- NDF Trowbridge Reitz Anisotropic$-- Schlick IOR Fresnel$;0;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;450;1664,-704;Inherit;False;PBR Core;1;;62248;d226ce46eb9ddb04ba9f0a949b5fddfe;21,213,1,2520,5,240,5,215,2,536,0,545,1,1279,1,908,1,1588,1,1886,1,1463,0,1887,1,2285,0,2543,0,2239,0,2242,0,2246,0,2243,0,2706,0,2235,0,2756,0;0;4;FLOAT3;0;FLOAT;156;FLOAT;159;FLOAT;158
Node;AmplifyShaderEditor.StandardSurfaceOutputNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;179;2048,-944;Float;False;True;-1;3;AmplifyShaderEditor.MaterialInspector;0;0;CustomLighting;AmplifyShaderPack/Community/Physical Based Rendering Hair;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;False;Off;0;False;;0;False;;False;0;False;;0;False;;False;0;Custom;0.58;True;True;0;True;TransparentCutout;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;_Cull;-1;0;True;_MaskClipValue2;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
WireConnection;179;9;450;156
WireConnection;179;10;450;159
WireConnection;179;13;450;0
ASEEND*/
//CHKSM=B693647D4079D8AC361CD72641CA0A92C576EBDD