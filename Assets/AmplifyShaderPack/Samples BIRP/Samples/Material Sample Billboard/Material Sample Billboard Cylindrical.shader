...
Shader "AmplifyShaderPack/Material Sample Billboard Cylindrical"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float dotResult960_g38 = dot( ase_normalWSNorm , ase_viewDirSafeWS );
			float3 lerpResult966_g38 = lerp( ase_normalOS , -ase_normalOS , step( dotResult960_g38 , -1.0 ));
			v.normal = lerpResult966_g38;
			float4 appendResult956_g38 = (float4(cross( ase_normalOS , float3( 0, 0, 1 ) ) , -1.0));
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 m_Flip1079_g38 = ( UnpackScaleNormal( tex2D( _BumpMap, temp_output_1623_0_g38 ), _NormalStrength ) * i.ASEIsFrontFace );
			float3 break1074_g38 = UnpackScaleNormal( tex2D( _BumpMap, temp_output_1623_0_g38 ), _NormalStrength );
			float3 appendResult1084_g38 = (float3(break1074_g38.x , break1074_g38.y , ( break1074_g38.z * i.ASEIsFrontFace )));
			...
			float dotResult1120_g38 = dot( reflect( ase_lightDirWS , (WorldNormalVector( i , Normal937_g38 )) ) , -ase_viewDirWS );
			...
			float3 normalizeResult1355_g38 = normalize( cross( ddy( ase_positionWS ) , ddx( ase_positionWS ) ) );
			float3 ase_viewDirSafeWS = Unity_SafeNormalize( ase_viewVectorWS );
			float dotResult1335_g38 = dot( normalizeResult1355_g38 , ase_viewDirSafeWS );
...
/*ASEBEGIN
Version=19902
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;37;128,-80;Inherit;False;Constant;_MaskClipValue2;Mask Clip Value;19;1;[HideInInspector];Create;True;1;;0;0;True;0;False;0.45;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;14;128,-160;Inherit;False;Property;_Cull;Render Face;0;1;[Enum];Create;False;1;;0;1;Front,2,Back,1,Both,0;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;48;-256,0;Inherit;False;Material Sample Billboard;1;;38;e113bea83f119734b93497bfc7434083;8,1406,0,1411,0,1412,0,1416,1,1415,1,1417,1,1414,1,885,1;0;13;FLOAT3;0;FLOAT3;556;FLOAT;56;FLOAT3;770;FLOAT;50;FLOAT;57;FLOAT;49;FLOAT;351;FLOAT;649;FLOAT;1692;FLOAT3;458;FLOAT3;967;FLOAT4;968
Node;AmplifyShaderEditor.StandardSurfaceOutputNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;0;128,0;Float;False;True;-1;3;AmplifyShaderEditor.MaterialInspector;0;0;StandardSpecular;AmplifyShaderPack/Material Sample Billboard Cylindrical;False;False;False;False;False;False;False;False;False;False;False;False;True;False;True;False;False;False;True;True;True;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Custom;0.45;True;True;0;True;TreeBillboard;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Spherical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;_Cull;-1;0;True;_MaskClipValue2;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=4D5774979729D08104C5BF0405A2D1D614ACCCFE