...
[CustomEditor(typeof(MovementGraphPreset))]
public class MovementGraphPresetEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("Movement Graph Preset Search", EditorStyles.boldLabel);
