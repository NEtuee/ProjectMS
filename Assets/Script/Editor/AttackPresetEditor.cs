...
[CustomEditor(typeof(AttackPreset))]
public class AttackPresetEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("Attack Preset Search", EditorStyles.boldLabel);
        ...
        // Draw the default list if there is no search term
        ...
        {
            // Draw only the filtered elements
