...
[CustomEditor(typeof(AnimationScalePreset))]
public class AnimationScalePresetEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("Animation Scale Preset Search", EditorStyles.boldLabel);
