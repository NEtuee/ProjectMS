...
public class HPSphereUI
{
    ...
    public void createSpriteRenderObject()
    {
        ...
        _hpSpriteObject.layer = LayerMask.NameToLayer("EffectEtc");
        ...
        _bpGaugeSpriteObject.layer = LayerMask.NameToLayer("EffectEtc");
        ...
        _bpAnimationSpriteObject.layer = LayerMask.NameToLayer("EffectEtc");
